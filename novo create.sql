...
insert into cliente values (default, 'Carlos Ferreira', '321.654.987-00', '1978-11-30', null, 'carlos.ferreira@example.com', 'senhaxyz', '(51) 77777-7777');
...
insert into categoria values (default, 'Workaholic');
insert into categoria values (default, 'Party');
...
insert into cor values (DEFAULT, 'Ciano');
...
insert into roupa values(DEFAULT, 'Disponível', '2020-01-20', null, 'S', 'Novo', 'Blusa');
...
insert into pedido values (default,'Pendente', '2022-10-30', 'RA012325', 5, 1);    -- Pedido 10: Pendente, cliente Carlos Ferreira, entregador 1
insert into pedido values (default,'Pendente', '2021-10-30', 'RA012328', 5, 1);    -- Pedido 10: Pendente, cliente Carlos Ferreira, entregador 1
